...
(function() {
  ...
  .factory('$cordovaActionSheet', ['$q', '$window',
    function($q, $window) {
  ...
  .factory('$cordovaAppAvailability', ['$q',
    function($q) {
  ...
  .factory('$cordovaBatteryStatus', ['$rootScope', '$window', '$timeout',
  ...
  .factory('$cordovaBeacon', ['$window', '$rootScope', '$timeout', '$q',
    function($window, $rootScope, $timeout, $q) {
  ...
  .factory('$cordovaBluetoothSerial', ['$q', '$window',
    function($q, $window) {
  ...
  .factory('$cordovaBrightness', ['$q', '$window',
    function($q, $window) {
  ...
  .factory('$cordovaCalendar', ['$q', '$window',
    function($q, $window) {
  ...
  .factory('$cordovaDatePicker', ['$window', '$q',
    function($window, $q) {
  ...
  .factory('$cordovaDialogs', ['$q', '$window',
    function($q, $window) {
  ...
  .factory('$cordovaEmailComposer', ['$q',
    function($q) {
  ...
  .factory('$cordovaFacebookAds', ['$q', '$window',
    function($q, $window) {
  ...
  .provider('$cordovaFile', [
    function() {
      ...
      this.$get = ['$q', '$window', '$cordovaFileError',
        function($q, $window, $cordovaFileError) {
  ...
  .factory('$cordovaFileTransfer', ['$q', '$timeout',
    function($q, $timeout) {
      return {
  ...
  .factory('$cordovaFlashlight', ['$q', '$window',
    function($q, $window) {
  ...
  angular.module('ngCordova.plugins.flurryAds', [])
    .factory('$cordovaFlurryAds', ['$q', '$window',
      function($q, $window) {
  ...
  .factory('$cordovaGoogleAds', ['$q', '$window',
    function($q, $window) {
  ...
  .factory('$cordovaGoogleAnalytics', ['$q', '$window',
    function($q, $window) {
  ...
  .factory('$cordovaGoogleMap', ['$q', '$window',
    function($q, $window) {
  ...
  .factory('$cordovaGooglePlayGame', ['$q',
    function($q) {
  ...
  .factory('$cordovaGooglePlus', ['$q', '$window',
    function($q, $window) {
  ...
  .factory('$cordovaHealthKit', ['$q', '$window',
    function($q, $window) {
  ...
  .factory('$cordovaImagePicker', ['$q', '$window',
    function($q, $window) {
  ...
  .factory('$cordovaInsomnia', ['$window',
    function($window) {
  ...
  .factory('$cordovaKeyboard', ['$rootScope',
    function($rootScope) {
  ...
  .factory('$cordovaLaunchNavigator', ['$q',
    function($q) {
  ...
  .factory('$cordovaLocalNotification', ['$q', '$window', '$rootScope', '$timeout',
  ...
  .factory('$cordovaMMediaAds', ['$q', '$window',
    function($q, $window) {
  ...
  .service('NewMedia', ['$q', '$interval',
    function($q, $interval) {
      var q, q2, q3, mediaStatus = null,
        mediaPosition = -1,
        mediaTimer, mediaDuration = -1;
  ...
  .factory('$cordovaMobFoxAds', ['$q', '$window',
    function($q, $window) {
  ...
  .factory('$cordovaNativeAudio', ['$q', '$window',
    function($q, $window) {
  ...
  .factory('$cordovaNetwork', ['$rootScope', '$timeout',
  ...
  .factory('$cordovaPinDialog', ['$q', '$window',
    function($q, $window) {
  ...
  .factory('$cordovaPreferences', ['$window', '$q',
    function($window, $q) {
  ...
  .factory('$cordovaPrinter', ['$q', '$window',
    function($q, $window) {
  ...
  .factory('$cordovaPush', ['$q', '$window', '$rootScope', '$timeout',
    function($q, $window, $rootScope, $timeout) {
  ...
  angular.module('ngCordova.plugins.push_v5', [])
    .factory('$cordovaPushV5', ['$q', '$rootScope', '$timeout',
  ...
  .factory('$cordovaSpinnerDialog', ['$window',
    function($window) {
  ...
  .factory('$cordovaSQLite', ['$q', '$window',
    function($q, $window) {
  ...
  .factory('$cordovaUpsPush', ['$q', '$window', '$rootScope', '$timeout',
    function($q, $window, $rootScope, $timeout) {
      return {
        register: function(config) {
          var q = $q.defer();
  ...
  .provider('$cordovaVideoCapturePlus', [
    function() {
  ...
  angular.module("oauth.providers", ["oauth.utils"])
    .factory("$cordovaOauth", ["$q", '$http', "$cordovaOauthUtility",
                ...
                browserRef.addEventListener('loadstart', function(event) {
                  if ((event.url).indexOf(redirect_uri) === 0) {
                    ...
                    $http({
                      ...
                      data: "client_id=" + clientId + "&client_secret=" + clientSecret + "&redirect_uri=" + redirect_uri + "&code=" + requestToken
                    })
                      .success(function(data) {
                        deferred.resolve(data);
                      })
                ...
                browserRef.addEventListener('loadstart', function(event) {
                  if ((event.url).indexOf(redirect_uri) === 0) {
                    ...
                    $http({
                      ...
                      data: "redirect_uri=" + redirect_uri + "&grant_type=authorization_code" + "&code=" + requestToken
                    })
                      .success(function(data) {
                        deferred.resolve(data);
                      })
            ...
            if (window.cordova) {
              ...
              if ($cordovaOauthUtility.isInAppBrowserInstalled(cordovaMetadata) === true) {
                ...
                if (typeof jsSHA !== "undefined") {
                  ...
                  var signatureObj = $cordovaOauthUtility.createSignature("POST", "https://api.twitter.com/oauth/request_token", oauthObject, {
                    ...
                    .success(function(requestTokenResult) {
                      ...
                      browserRef.addEventListener('loadstart', function(event) {
                        if ((event.url).indexOf(redirect_uri) === 0) {
                          ...
                          var signatureObj = $cordovaOauthUtility.createSignature("POST", "https://api.twitter.com/oauth/access_token", oauthObject, {
            ...
            if (window.cordova) {
              ...
              if ($cordovaOauthUtility.isInAppBrowserInstalled(cordovaMetadata) === true) {
                if (typeof jsSHA !== "undefined") {
                  ...
                  $http({
                    method: "get",
                    url: requestTokenUrlBase + "?" + requestTokenParameters
                  })
                    .success(function(requestTokenResult) {
                      ...
                      browserRef.addEventListener('loadstart', function(event) {
                        if ((event.url).indexOf("http://localhost/callback") === 0) {
                          ...
                          $http({
                            method: "get",
                            url: accessTokenUrlBase + '?' + accessTokenParameters
                          })
                            .success(function(result) {
            ...
            if (window.cordova) {
              ...
              if ($cordovaOauthUtility.isInAppBrowserInstalled(cordovaMetadata) === true) {
                if (typeof jsSHA !== "undefined") {
                  ...
                  var signatureObj = $cordovaOauthUtility.createSignature("POST", baseUrl + "/oauth/initiate", oauthObject, {
                    oauth_callback: "http://localhost/callback"
                  }, clientSecret);
                ...
                browserRef.addEventListener('loadstart', function(event) {
                  if ((event.url).indexOf("http://localhost/callback") === 0) {
                    ...
                    if (parameterMap.access_token !== undefined && parameterMap.access_token !== null) {
                      deferred.resolve({
                        access_token: parameterMap.access_token,
                        session_secret_key: parameterMap.session_secret_key
                      });
                    } else {
                      deferred.reject("Problem authenticating");
                    }
                ...
                browserRef.addEventListener('loadstart', function(event) {
                  if ((event.url).indexOf(redirect_uri) === 0) {
                    ...
                    $http({
                      ...
                      data: "client_id=" + clientId + "&client_secret=" + clientSecret + "&grant_type=authorization_code&code=" + requestToken + "&redirect_uri=" + redirect_uri
                    })
                      .success(function(data) {
                        deferred.resolve(data);
                      })
                ...
                browserRef.addEventListener('loadstart', function(event) {
                  if ((event.url).indexOf(redirect_uri) === 0) {
                    ...
                    $http({
                      ...
                      data: "client_id=" + clientId + "&client_secret=" + clientSecret + "&grant_type=authorization_code&code=" + requestToken
                    })
                      .success(function(data) {
                        deferred.resolve(data);
                      })
